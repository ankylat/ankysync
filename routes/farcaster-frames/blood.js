...
router.get("/", async (req, res) => {
  try {
    ...
    <head>
      ...
      <meta property="og:image" content="https://github.com/jpfraneto/images/blob/main/blood.png?raw=true">
      <meta name="fc:frame" content="vNext">
      <meta name="fc:frame:image" content="https://github.com/jpfraneto/images/blob/main/blood.png?raw=true">
...
router.post("/", async (req, res) => {
  try {
    ...
    <head>
      ...
      <meta property="og:image" content="https://github.com/jpfraneto/images/blob/main/alchemy.png?raw=true">
      <meta name="fc:frame:image" content="https://github.com/jpfraneto/images/blob/main/alchemy.png?raw=true">
      <meta name="fc:frame" content="vNext">
